...
const supabaseUrl = process.env.NEXT_PUBLIC_SUPABASE_URL || 'https://mqubrlzjbtlumskdgcdp.supabase.co';
const supabaseKey = process.env.NEXT_PUBLIC_SUPABASE_PUBLISHABLE_KEY || 'sb_publishable_e6fMOVwUJyhRWN0wC8dNjw__HwPtfzv';
